function checkEmail()
{
    ...
    if( email == "")//conditional expression, when it is true the code in the block will be executed
    {
    ...
    //check to see if the confirm textbox is empty
    if( confirm == "") //conditional expression, when it is true the code in the block will be executed
    {
    ...
    {
        //print error
        document.getElementById("confirm-error").innerHTML = "both email must be the same";
        document.getElementById("email-error").innerHTML = "both email must be the same";
    }
}
